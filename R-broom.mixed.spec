...
Version  : 0.2.7
Release  : 1
URL      : https://cran.r-project.org/src/contrib/broom.mixed_0.2.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/broom.mixed_0.2.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642532436
